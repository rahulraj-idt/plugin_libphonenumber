...
class PhoneNumberUtil {
  ...
  /// Returns [Future<bool>].
  static Future<bool?> isValidPhoneNumber(String phoneNumber,
  ...
  static Future<String?> normalizePhoneNumber(String phoneNumber,
      String isoCode) async {
  ...
  static Future<RegionInfo> getRegionInfo(String phoneNumber,
      String isoCode) async {
    try {
  ...
  static Future<PhoneNumberType> getNumberType(String phoneNumber,
      String isoCode) async {
  ...
  /// Accepts [phoneNumber] and [isoCode]
  /// Returns [Future<String>]
  static Future<String?> formatAsYouType(String phoneNumber,
      String isoCode) async {
    try {
  ...
  static Future<String?> getFormattedExampleNumber(String isoCode,
      PhoneNumberType type, PhoneNumberFormat format) async {
    return await _platform.getFormattedExampleNumber(isoCode, type, format);
  }

  static Future<ParsedPhoneNumber?> parsePhoneNumber(String phoneNumber,
      String isoCode) async {
